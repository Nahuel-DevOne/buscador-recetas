function iniciarApp(){
    ...
    function obtenerCategorias(){
        ...
        // Llamado a la API. Por default es GET
        fetch(url)
    ...
    function mostrarCategorias(categorias = []){
        categorias.forEach(categoria => {
            // Destructuring para extraer los valores de categoria
    ...
    function mostrarRecetas(recetas = []){
        ...
        heading.classList.add('text-center', 'text-dark', 'my-3');
    ...
    function obtenerFavoritos(){
        ...
        noFavoritos.classList.add('text-center', 'text-danger', 'fs-3', 'font-bold', 'mt-5', 'border-bottom', 'border-2', 'border-danger', 'p-2');
